...
<div class="weui-panel weui-panel_access" style="margin-top:0;">
    <div class="weui-panel__bd">
        <div class="weui-media-box weui-media-box_text">
            ...
            <h4 class="weui-media-box__title" style="color: #D02090; font-weight: 600;"><c:if test="${goodbean.openid!=null && goodbean.openid!=''}"><a href="${goodbean.wangpandizhi}"><img src="/wweixin/weixin/images/54.png"></a></c:if></h4>
            ...
            <h4 class="weui-media-box__title" style="color: #D02090; font-weight: 600;"><c:if test="${goodbean.shifoumianfei=='Y'}"><a href="${goodbean.wangpandizhi}"><img src="/wweixin/weixin/images/54.png"></a></c:if></h4>
